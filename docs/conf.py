...
g = {}
with open(
    os.path.join(os.path.dirname(__file__), "..", "invenio_rdm_pure", "version.py"),
    "rt",
) as fp:
    exec(fp.read(), g)
...
latex_documents = [
    (
        ...
        u"invenio-rdm-pure Documentation",
        u"Technische Universität Graz",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "invenio-rdm-pure", u"invenio-rdm-pure Documentation", [author], 1)
]
